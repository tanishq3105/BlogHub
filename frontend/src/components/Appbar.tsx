...
export const Appbar = () => {
  ...
  return (
    <div className="flex items-center justify-between p-4 sm:px-8 border-b-2 sticky top-0 bg-white z-50">
      <div className="font-bold cursor-pointer text-xl">
        <Link to="/blogs">Blog Hub</Link>
      </div>
      <div className="hidden md:flex space-x-4 items-center">
        <Link to="/create" className="flex items-center hover:text-indigo-600">
          <svg
